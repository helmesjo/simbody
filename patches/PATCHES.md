...
constructors (patch 04) to also be `constexpr`. Use `patch/all-constexpr` (four
sequential commits: NTraits/Scalar, CoordinateAxis, Vec, DecorativeGeometry) for
the actual PR and for full static-build verification.
